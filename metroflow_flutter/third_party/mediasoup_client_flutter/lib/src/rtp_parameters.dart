...
class RtpEncodingParameters extends RTCRtpEncoding {
  ...
  set networkPriority(RTCPriorityType? value) {
    switch (value) {
      case RTCPriorityType.veryLow:
        _networkPriority = Priority.VeryLow;
        break;
      case RTCPriorityType.low:
        _networkPriority = Priority.Low;
        break;
      case RTCPriorityType.medium:
        _networkPriority = Priority.Medium;
        break;
      case RTCPriorityType.high:
        _networkPriority = Priority.High;
        break;
      default:
        _networkPriority = null;
    }
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (_networkPriority != null) 'networkPriority': _networkPriority?.value,
    };
  }
  ...
  static RtpEncodingParameters assign(
    ...
    return RtpEncodingParameters(
      ...
      priority: next._priority ?? prev._priority,
      networkPriority: next._networkPriority ?? prev._networkPriority,
      active: next.active,
